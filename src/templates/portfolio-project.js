  ...
  return (
    <Layout>
      ...
      <div>
        ...
        <div className={`d-flex ${pageContext.prev ? "justify-content-between" : "justify-content-end"} mt-5`}>
          { pageContext.prev && (
            <ItemPagination className="d-flex align-items-center" to={pageContext.prev.fields.slug}>
              ...
              <span>{pageContext.prev.frontmatter.title}</span>
            </ItemPagination>
          )}
          { pageContext.next && (
            <ItemPagination className="d-flex align-items-center" to={pageContext.next.fields.slug}>
